    ...
    public partial class DboTicariOtomasyonDataSet : global::System.Data.DataSet {
        ...
        public partial class Tbl_FirmalarRow : global::System.Data.DataRow {
            ...
            public string Faks {
                get {
                    try {
                        return ((string)(this[this.tableTbl_Firmalar.FaksColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Faks\' in table \'Tbl_Firmalar\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTbl_Firmalar.FaksColumn] = value;
                }
            }
            ...
            public bool IsFaksNull() {
                return this.IsNull(this.tableTbl_Firmalar.FaksColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetFaksNull() {
                this[this.tableTbl_Firmalar.FaksColumn] = global::System.Convert.DBNull;
            }
    ...
    public partial class Tbl_FirmalarTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Tbl_Firmalar] WHERE (([ID] = @Original_ID) AND ((@IsNull_Ad = " +
                ...
                "ail = 1 AND [Mail] IS NULL) OR ([Mail] = @Original_Mail)) AND ((@IsNull_Faks = 1" +
                " AND [Faks] IS NULL) OR ([Faks] = @Original_Faks)) AND ((@IsNull_Il = 1 AND [Il]" +
                " IS NULL) OR ([Il] = @Original_Il)) AND ((@IsNull_Ilce = 1 AND [Ilce] IS NULL) O" +
                "R ([Ilce] = @Original_Ilce)) AND ((@IsNull_VergiDaire = 1 AND [VergiDaire] IS NU" +
                "LL) OR ([VergiDaire] = @Original_VergiDaire)) AND ((@IsNull_Adres = 1 AND [Adres" +
                "] IS NULL) OR ([Adres] = @Original_Adres)) AND ((@IsNull_OzelKod1 = 1 AND [OzelK" +
                "od1] IS NULL) OR ([OzelKod1] = @Original_OzelKod1)) AND ((@IsNull_OzelKod2 = 1 A" +
                "ND [OzelKod2] IS NULL) OR ([OzelKod2] = @Original_OzelKod2)) AND ((@IsNull_OzelK" +
                "od3 = 1 AND [OzelKod3] IS NULL) OR ([OzelKod3] = @Original_OzelKod3)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Tbl_Firmalar] ([Ad], [YetkiliStatu], [YetkiliAdSoyad], [YetkiliTc], [Sektor], [Telefon1], [Telefon2], [Telefon3], [Mail], [Faks], [Il], [Ilce], [VergiDaire], [Adres], [OzelKod1], [OzelKod2], [OzelKod3]) VALUES (@Ad, @YetkiliStatu, @YetkiliAdSoyad, @YetkiliTc, @Sektor, @Telefon1, @Telefon2, @Telefon3, @Mail, @Faks, @Il, @Ilce, @VergiDaire, @Adres, @OzelKod1, @OzelKod2, @OzelKod3);
SELECT ID, Ad, YetkiliStatu, YetkiliAdSoyad, YetkiliTc, Sektor, Telefon1, Telefon2, Telefon3, Mail, Faks, Il, Ilce, VergiDaire, Adres, OzelKod1, OzelKod2, OzelKod3 FROM Tbl_Firmalar WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Tbl_Firmalar] SET [Ad] = @Ad, [YetkiliStatu] = @YetkiliStatu, [Yetk" +
                ...
                "ail, [Faks] = @Faks, [Il] = @Il, [Ilce] = @Ilce, [VergiDaire] = @VergiDaire, [Ad" +
                "res] = @Adres, [OzelKod1] = @OzelKod1, [OzelKod2] = @OzelKod2, [OzelKod3] = @Oze" +
                "lKod3 WHERE (([ID] = @Original_ID) AND ((@IsNull_Ad = 1 AND [Ad] IS NULL) OR ([A" +
                "d] = @Original_Ad)) AND ((@IsNull_YetkiliStatu = 1 AND [YetkiliStatu] IS NULL) O" +
                "R ([YetkiliStatu] = @Original_YetkiliStatu)) AND ((@IsNull_YetkiliAdSoyad = 1 AN" +
                "D [YetkiliAdSoyad] IS NULL) OR ([YetkiliAdSoyad] = @Original_YetkiliAdSoyad)) AN" +
                "D ((@IsNull_YetkiliTc = 1 AND [YetkiliTc] IS NULL) OR ([YetkiliTc] = @Original_Y" +
                "etkiliTc)) AND ((@IsNull_Sektor = 1 AND [Sektor] IS NULL) OR ([Sektor] = @Origin" +
                "al_Sektor)) AND ((@IsNull_Telefon1 = 1 AND [Telefon1] IS NULL) OR ([Telefon1] = " +
                "@Original_Telefon1)) AND ((@IsNull_Telefon2 = 1 AND [Telefon2] IS NULL) OR ([Tel" +
                "efon2] = @Original_Telefon2)) AND ((@IsNull_Telefon3 = 1 AND [Telefon3] IS NULL)" +
                " OR ([Telefon3] = @Original_Telefon3)) AND ((@IsNull_Mail = 1 AND [Mail] IS NULL" +
                ") OR ([Mail] = @Original_Mail)) AND ((@IsNull_Faks = 1 AND [Faks] IS NULL) OR ([" +
                "Faks] = @Original_Faks)) AND ((@IsNull_Il = 1 AND [Il] IS NULL) OR ([Il] = @Orig" +
                "inal_Il)) AND ((@IsNull_Ilce = 1 AND [Ilce] IS NULL) OR ([Ilce] = @Original_Ilce" +
                ")) AND ((@IsNull_VergiDaire = 1 AND [VergiDaire] IS NULL) OR ([VergiDaire] = @Or" +
                "iginal_VergiDaire)) AND ((@IsNull_Adres = 1 AND [Adres] IS NULL) OR ([Adres] = @" +
                "Original_Adres)) AND ((@IsNull_OzelKod1 = 1 AND [OzelKod1] IS NULL) OR ([OzelKod" +
                "1] = @Original_OzelKod1)) AND ((@IsNull_OzelKod2 = 1 AND [OzelKod2] IS NULL) OR " +
                "([OzelKod2] = @Original_OzelKod2)) AND ((@IsNull_OzelKod3 = 1 AND [OzelKod3] IS " +
                "NULL) OR ([OzelKod3] = @Original_OzelKod3)));\r\nSELECT ID, Ad, YetkiliStatu, Yetk" +
                "iliAdSoyad, YetkiliTc, Sektor, Telefon1, Telefon2, Telefon3, Mail, Faks, Il, Ilc" +
                "e, VergiDaire, Adres, OzelKod1, OzelKod2, OzelKod3 FROM Tbl_Firmalar WHERE (ID =" +
                " @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Ad, YetkiliStatu, YetkiliAdSoyad, YetkiliTc, Sektor, Telefon1, Telefon" +
                "2, Telefon3, Mail, Faks, Il, Ilce, VergiDaire, Adres, OzelKod1, OzelKod2, OzelKo" +
                "d3 FROM dbo.Tbl_Firmalar";
        ...
        public virtual int Delete(
            ...
            if ((Original_Faks == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[20].Value = ((string)(Original_Faks));
            }
            if ((Original_Il == null)) {
        ...
        public virtual int Update(
            ...
            if ((Faks == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Faks));
            }
            if ((Il == null)) {
            ...
            if ((Original_Faks == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[37].Value = ((string)(Original_Faks));
            }
            if ((Original_Il == null)) {
